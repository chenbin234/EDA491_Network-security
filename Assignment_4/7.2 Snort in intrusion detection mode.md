...
- The payload could also be a disassembled code that the attacker wanted to execute at the host machine. More on disassembly and shell code can be found on this link: https://infosecwriteups.com/exploitation-with-shellcode-23470cd2aa55
...
```shell
alert tcp !10.0.0.1/24 any -> $HOME any (msg:"illegal source ip address"; sid: 100009)
```
...
![final_rules](images/final_rules.png)
